...
CodeMirror.defineMode("css", function(config, parserConfig) {
  ...
  var propertyKeywords_ = [
    "align-content", "align-items", "align-self", "alignment-adjustBase",
    ...
    "dominant-baseline", "drop-initial-after-adjustBase",
    "drop-initial-after-align", "drop-initial-before-adjustBase",
    "drop-initial-before-align", "drop-initial-size", "drop-initial-value",
    "elevation", "empty-cells", "fit", "fit-position", "flex", "flex-basis",
    "flex-direction", "flex-flow", "flex-grow", "flex-shrink", "flex-wrap",
    "float", "float-offset", "flow-from", "flow-into", "font", "font-feature-settings",
    "font-family", "font-kerning", "font-language-override", "font-size", "font-size-adjustBase",
    ...
    "text-size-adjustBase", "text-space-collapse", "text-transform", "text-underline-position",
